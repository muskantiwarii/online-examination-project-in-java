...
{  
    ...
    {  
        ...
        if(current==0)  
        {  
            l.setText("Que1: Who is known as father of computer?");  
            jb[0].setText("charles Babbage");jb[1].setText("James Gosling");jb[2].setText("M.P.Java");jb[3].setText("Blais Pascal");   
        }  
        if(current==1)  
        {  
            l.setText("Que2:who is known as father of java programming?");  
            jb[0].setText("alexandar bell");jb[1].setText("james gosling");jb[2].setText("gilad bracha");jb[3].setText("linus torva");  
        }  
        if(current==2)  
        {  
        ...
        if(current==4)  
        {  
            l.setText("Que5:What are the features reused using Inheritance in Java?");  
            jb[0].setText("method");jb[1].setText("variables");jb[2].setText("Constant");jb[3].setText("all of the above");  
        }  
        if(current==5)  
        {  
        ...
        if(current==8)  
        {  
            l.setText("Que9:  The class that is being inherited or subclassed is called ___.");  
            jb[0].setText("ArithmeticException");jb[1].setText("Throwable");jb[2].setText("subclass");jb[3].setText("superclass");  
        }  
        if(current==9)  
        {  
